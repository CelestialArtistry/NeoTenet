...
public class NeoTenetInterfaceInvokerGen implements PluginTransformer {

    public static final NeoTenetInterfaceInvokerGen INSTANCE = new NeoTenetInterfaceInvokerGen();
            ...
            for (Map.Entry<String, String> entry : set) {
                ...
                if (node != null && !node.name.equals(name)) {
                    ...
                    if (!extend) {
                        ...
                        NeoTenet.LOGGER.debug("Generated {} redirecting to {}", classNode.name + "/" + name + " " + desc, node.owner + "/" + node.name + " " + node.desc);
                    }
                }
            }
        }

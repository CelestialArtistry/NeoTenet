...
import org.celestial_artistry.neotenet.bukkit.remapping.ClassLoaderRemapping;
...
public class RemappingURLClassLoader extends URLClassLoader implements RemappingClassLoader {
    ...
    public NeoTenetRemapConfig config = new NeoTenetRemapConfig(ClassLoaderRemapping.canRemap(this));

package org.celestial_artistry.neotenet.bukkit.remapping.generated;

import org.celestial_artistry.neotenet.bukkit.remapping.NeoTenetRedirectAdapter;
import org.celestial_artistry.neotenet.bukkit.remapping.ClassLoaderRemapper;
import org.celestial_artistry.neotenet.bukkit.remapping.ClassRepoWrapper;
import org.celestial_artistry.neotenet.bukkit.remapping.Enumerations;
...
import org.celestial_artistry.neotenet.bukkit.remapping.Unsafe;
...
public class NeoTenetReflectionHandler extends ClassLoader {
    ...
    public static Object[] handleMethodInvoke(Method method, Object src, Object[] param) throws Throwable {
        Object[] ret = NeoTenetRedirectAdapter.runHandle(remapper, method, src, param);
        if (ret != null) {
            return ret;
        } else {
    ...
    public static Object redirectMethodInvoke(Method method, Object src, Object[] param) throws Throwable {
        Object ret = NeoTenetRedirectAdapter.runRedirect(remapper, method, src, param);
        if (ret != remapper) {
            return ret;
        } else {
    ...
    public static byte[] transformOrAdd(ClassLoader loader, byte[] bytes) {
        ...
        if (rcl != null) {
            ...
            NeoTenetRedirectAdapter.scanMethod(bytes);
            return bytes;
        }
    }
}
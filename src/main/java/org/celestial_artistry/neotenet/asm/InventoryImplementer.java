package org.celestial_artistry.neotenet.asm;
...
public class InventoryImplementer implements Implementer {
    ...
    private static final String BRIDGE_TYPE = "org/celestial_artistry/neotenet/injection/world/InjectionContainer";

    private final String maxStackSizeMethodName;

    public InventoryImplementer() {
        this.maxStackSizeMethodName = "getMaxStackSize";
    }

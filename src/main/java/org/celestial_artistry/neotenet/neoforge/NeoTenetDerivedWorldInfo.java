package org.celestial_artistry.neotenet.neoforge;
...
public class NeoTenetDerivedWorldInfo extends PrimaryLevelData {

    private final ServerLevelData derivedWorldInfo;

    public NeoTenetDerivedWorldInfo(ServerLevelData derivedWorldInfo, LevelSettings p_78470_, WorldOptions p_78471_, SpecialWorldProperty p_252268_, Lifecycle p_78472_) {
        super(p_78470_, p_78471_, p_252268_, p_78472_);
        this.derivedWorldInfo = derivedWorldInfo;
    }

    public static NeoTenetDerivedWorldInfo create(ServerLevelData worldInfo) {
        return new NeoTenetDerivedWorldInfo(worldInfo, worldSettings(worldInfo), generatorSettings(worldInfo), specialWorldProperty(worldInfo), lifecycle(worldInfo));
    }

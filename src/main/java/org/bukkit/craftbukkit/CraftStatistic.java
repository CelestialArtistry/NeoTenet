...
public enum CraftStatistic {
    ...
    static {
        ImmutableBiMap.Builder<ResourceLocation, Statistic> statisticBuilder = ImmutableBiMap.builder();
    ...
    public static Statistic getBukkitStatistic(net.minecraft.stats.Stat<?> statistic) {

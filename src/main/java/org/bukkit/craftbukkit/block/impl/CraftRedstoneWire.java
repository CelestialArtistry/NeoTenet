...
public final class CraftRedstoneWire extends org.bukkit.craftbukkit.block.data.CraftBlockData implements org.bukkit.block.data.type.RedstoneWire, org.bukkit.block.data.AnaloguePowerable {
    ...
    public Connection getFace(org.bukkit.block.BlockFace face) {
        switch (face) {
            case NORTH:
                return this.get(CraftRedstoneWire.NORTH, Connection.class);
            case EAST:
                return this.get(CraftRedstoneWire.EAST, Connection.class);
            case SOUTH:
                return this.get(CraftRedstoneWire.SOUTH, Connection.class);
            case WEST:
                return this.get(CraftRedstoneWire.WEST, Connection.class);
            default:

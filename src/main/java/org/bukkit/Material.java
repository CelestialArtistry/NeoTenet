...
public enum Material implements Keyed, Translatable {
    ...
    public boolean isNeoForgeBlock = false;
    public boolean isNeoForgeItem = false;

    // NeoTaiyitist start - constructor used to set if the Material is a block or not
    private Material(final int id, final int stack, boolean isNeoForgeBlock, boolean isNeoForgeItem) {
        this(id, stack);
        this.isNeoForgeBlock = isNeoForgeBlock;
        this.isNeoForgeItem = isNeoForgeItem;
    }
    // Taiyitist end
    ...
    public boolean isItem() {
        if (isNeoForgeItem && !isNeoForgeBlock) {
            return true;
        }

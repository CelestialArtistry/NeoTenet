...
public abstract class MixinConcretePowderBlock extends Block {
    ...
    public boolean neotenet$blockForm(Level world, BlockPos pos, BlockState newState, int flags) {
    ...
    public BlockState neotenet$blockForm(Block instance, BlockPlaceContext context) {
    ...
    public BlockState neotenet$blockForm(Block instance, BlockState stateIn, Direction facing, BlockState facingState, LevelAccessor worldIn, BlockPos currentPos, BlockPos facingPos) {

...
import org.teneted.neotenet.bukkit.remapping.patcher.NeoTenetPluginPatcher;
import org.teneted.neotenet.bukkit.remapping.patcher.PluginPatcher;
import org.teneted.neotenet.bukkit.remapping.source.RemapSourceHandler;
...
public class NeoTenetRemapper {
    ...
    static {
        try {
            ...
            SWITCH_TABLE_FIXER = (Function<byte[], byte[]>) Class.forName("org.teneted.neotenet.asm.SwitchTableFixer").getField("INSTANCE").get(null);
        } catch (Exception e) {
